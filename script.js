...
let month = prompt("rentrer un mois : ");
let year = prompt("rentrer une année : ");
...
function calendrier(mois,an) {
    ...
    /**
     * @description cette fonction permet de générer un calendrier en fonction du mois et de l'année
     * 
     */
